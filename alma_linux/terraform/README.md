# AlmaLinux VM Provisioning using Terraform (Proxmox)

This directory contains Terraform code used to provision **AlmaLinux virtual machines on Proxmox**.
...
- AlmaLinux VM template already exists in Proxmox
...
- Clones AlmaLinux VM from a Packer-built template
